...
def send_email(csv_file):
    receiver_emails = ['sunday.abolaji@transformco.com', 'bolajidamilaresunday@gmail.com']
    
    # Email details
    sender_email = os.getenv("SMTP_SENDER_EMAIL")
    subject = 'Test Assurant PA'
    body = 'TEST - Please find attached the daily PA report.'
